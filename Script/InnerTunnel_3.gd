...
func draw_tunnel():
	...
	for i in range(0, segments.size(), 3):
		...
		var line_color = Color(0.083, 0.386, 0.695, 1.0) if (i / 3) % 2 == 0 else Color(0.74, 0.417, 0.847, 1.0)
